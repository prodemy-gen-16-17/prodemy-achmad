  ...
  return (
    ...
    <div>
      ...
      <div className="topnav bg-white overflow-hidden text-center">
        <a className="active inline-block py-2 px-4" href="#">Femworld</a>
        <a href="#" className="inline-block py-2 px-4">New Arrivals</a>
        <a href="#" className="inline-block py-2 px-4">All Product</a>
        <a href="#" className="inline-block py-2 px-4">Blogs</a>
        <a href="#" className="inline-block py-2 px-4">Contact Us</a>
        <a href="#" className="logo-search font-bold text-black absolute top-30 right-190">Logo Search</a>
        <a href="#"
          className="get-started absolute top-30 right-50 border border-black py-1 px-2 bg-black rounded text-white">Get
          Started</a>
      </div>
      {/* akhir navbar */}
